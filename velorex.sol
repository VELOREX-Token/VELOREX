...
OFFICIAL CONTACTS 
 ...
 Telegram - https://t.me/VelorEX_announcements
 Discord - https://discord.gg/AFMM9hfWu6
 Twitter - https://twitter.com/velorex_cc
 Reddit - https://reddit.com/r/VELOREX

Clearification: This contract is a migrated contract from the following contract 0xa9295088153e195fd37e443dd482d1318a669661.
Reasons behind migration:

1. First migration was publicly announced, and its very unsafe and unfair for all of our investors and their long term interests.
Example: 1 BNB was equal to 780,000 VEX tokens when we launched and because of bots the price went down to 1.5-2.5 million VEX tokens per BNB.
We offer full refund for those who bought large amounts of VEX tokens which resulted in them having an unfair advantage from the first migration.

2. Liquidity problem due to migration
Upon reconsideration - the initial ICO did not provide us with a satisfactory amount of initial liquidity. This was potentially  dangerous for all of our investors and we decided perform another Pre-Sale.

This migration was done only to protect investors, and help VELOREX grow in the long term.
*/
...
contract VELOREX is Context, IBEP20, Ownable {
    ...
    uint256 public _liquidityFee = 300; // 3% of every transaction will be converted into BNB. Within that 5%, 3% will go towards charitable donations and 2% will go towards marketing and the team
